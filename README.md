...
You can use the following function for solving the problem arise when putting a ListView inside a ScrollView. This will help you to set the height of ListView as the item sum of list item height.
